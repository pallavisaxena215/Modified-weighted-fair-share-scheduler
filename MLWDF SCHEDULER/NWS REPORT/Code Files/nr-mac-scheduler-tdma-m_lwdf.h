 ...
 * NrMacSchedulerUeInfoMLWDF.
 */
class NrMacSchedulerTdmaMLWDF : public NrMacSchedulerTdmaRR
{
public:
  /**
   * \brief GetTypeId
  ...
  /**
   * \brief NrMacSchedulerTdmaMLWDF constructor
   */
  NrMacSchedulerTdmaMLWDF ();

  /**
   * \brief ~NrMacSchedulerTdmaMLWDF deconstructor
   */
  virtual ~NrMacSchedulerTdmaMLWDF () override
  {
  }
...
protected:
  // inherit
  /**
   * \brief Create an UE representation of the type NrMacSchedulerUeInfoMLWDF
   ...
   * \return a pointer to NrMacSchedulerUeInfoMLWDF::CompareUeWeightsDl
   */
   ...
   * \return a pointer to NrMacSchedulerUeInfoMLWDF::CompareUeWeightsUl
   */
  virtual std::function<bool(const NrMacSchedulerNs3::UePtrAndBufferReq &lhs,
                             const NrMacSchedulerNs3::UePtrAndBufferReq &rhs )>
  ...
  /**
   * \brief Update DL metrics by calling NrMacSchedulerUeInfoMLWDF::UpdatePFDlMetric
   ...
   * by calling the NrMacSchedulerUeInfoMLWDF::UpdateDlPFMetric, which in turn will
  ...
  /**
   * \brief Update UL metrics by calling NrMacSchedulerUeInfoMLWDF::UpdatePFUlMetric
   * \param ue UE to update
   * \param assigned the amount of resources assigned
   * \param totAssigned the total amount of resources assigned in the slot
   *
   * The UL metrics (current Throughput and average Throughput) will be updated
   * by calling the NrMacSchedulerUeInfoMLWDF::UpdateUlPFMetric, which in turn will
   ...
   * NrMacSchedulerUeInfoMLWDF::CalculatePotentialTPutDl.
   */
  virtual void
   ...
   *
   * Calculates the the potential throughput by calling
   * NrMacSchedulerUeInfoMLWDF::CalculatePotentialTPutUl.
   */
  virtual void
