...
NS_LOG_COMPONENT_DEFINE ("NrMacSchedulerUeInfoMLWDF");

void
NrMacSchedulerUeInfoMLWDF::UpdateDlPFMetric (const NrMacSchedulerNs3::FTResources &totAssigned,
                                              double timeWindow,
...
void
NrMacSchedulerUeInfoMLWDF::UpdateUlPFMetric (const NrMacSchedulerNs3::FTResources &totAssigned,
                                              double timeWindow,
                                              const Ptr<const NrAmc> &amc)
{
  NS_LOG_FUNCTION (this);
...
void
NrMacSchedulerUeInfoMLWDF::CalculatePotentialTPutDl (const NrMacSchedulerNs3::FTResources &assignableInIteration,
                                                    const Ptr<const NrAmc> &amc,
                                                    int holDelay)
{
  NS_LOG_FUNCTION (this);
  m_HolDelay = holDelay;
  //std::cout<<"ueInfo mlwdf cc "<<m_HolDelay<<std::endl;
...
void
NrMacSchedulerUeInfoMLWDF::CalculatePotentialTPutUl (const NrMacSchedulerNs3::FTResources &assignableInIteration,
                                                    const Ptr<const NrAmc> &amc)
{
  NS_LOG_FUNCTION (this);
...
void 
NrMacSchedulerUeInfoMLWDF::SetDropProb (double dropInput){
  m_dProb = dropInput;
}
